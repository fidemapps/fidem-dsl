module.exports = (function() {
  ...
  function parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c22 = "in geofence",
        peg$c23 = { type: "literal", value: "in geofence", description: "\"in geofence\"" },
        peg$c24 = ",",
        ...
        peg$c36 = "every",
        peg$c37 = { type: "literal", value: "every", description: "\"every\"" },
        peg$c38 = function(first, remainders, months, years, time) {
                    return {
                        scope : 'every',
        ...
        peg$c39 = "day",
        peg$c40 = { type: "literal", value: "day", description: "\"day\"" },
        peg$c41 = function(months, years, time) {
                    return {
                        scope : 'every',
        ...
        peg$c42 = "member",
        peg$c43 = { type: "literal", value: "member", description: "\"member\"" },
        peg$c44 = "did",
        peg$c45 = { type: "literal", value: "did", description: "\"did\"" },
        ...
        peg$c49 = function(scope, type, conditions, filter1, filter2) {
                  return {
                      scope:scope,
                      type:type,
                      condition:conditions,
        ...
        peg$c50 = function(scope, type, conditions, filter2) {
                   return {
                       scope:scope,
                       type:type,
                       condition:conditions,
        ...
        peg$c56 = "nothing",
        peg$c57 = { type: "literal", value: "nothing", description: "\"nothing\"" },
        ...
        peg$c64 = "check-in",
        peg$c65 = { type: "literal", value: "check-in", description: "\"check-in\"" },
        peg$c66 = function(type, checkinCode, condition) {
                return {
                    type:type,
                    code:"check-in",
        ...
        peg$c67 = "something",
        peg$c68 = { type: "literal", value: "something", description: "\"something\"" },
        peg$c69 = function(type) {
                return {
                    type:type
                }
            },
        peg$c70 = function(actionCode, condition) {
            	return {
                	type:null,
                    code:actionCode,
                    conditions:condition
        ...
        peg$c71 = function(checkinCode, condition) {
            	return {
                	type:null,
                    code:'check-in',
                    conditions: condition ? condition.concat({
        ...
        peg$c76 = function(type, subType, number, object) {
                return {
                    type:type,
                    sub_type:subType,
                    number:number,
        ...
        peg$c77 = function(subType, number, object) {
                return {
                    type:null,
                    sub_type:subType,
                    number:number,
        ...
        peg$c89 = "at least",
        peg$c90 = { type: "literal", value: "at least", description: "\"at least\"" },
        peg$c91 = "times",
        ...
        peg$c96 = "less than",
        peg$c97 = { type: "literal", value: "less than", description: "\"less than\"" },
