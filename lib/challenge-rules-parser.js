module.exports = (function() {
  ...
  function parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c8 = null,
        peg$c9 = function(scope, actionCode, conditions, filters, system) {
        ...
        peg$c10 = "challenge",
        peg$c11 = { type: "literal", value: "challenge", description: "\"challenge\"" },
        peg$c12 = function(scope, challengeCode, conditions, filters) {
                return {
                    scope: scope,
                    code: challengeCode,
                    conditions: buildList(null, conditions, 1),
        ...
        peg$c13 = "member",
        peg$c14 = { type: "literal", value: "member", description: "\"member\"" },
        peg$c15 = "level",
        peg$c16 = { type: "literal", value: "level", description: "\"level\"" },
        peg$c17 = "point",
        peg$c18 = { type: "literal", value: "point", description: "\"point\"" },
        peg$c19 = function(scope, type, levelCode, operator, value, filter) {
                var theRule = {
                    scope: scope,
                    type: type,
                    levelCode: levelCode,
        ...
        peg$c22 = function(scope, type, tagCode, operator, value, filter) {
                var theRule = {
                    scope: scope,
                    type: type,
        ...
        peg$c23 = "in geofence",
        peg$c24 = { type: "literal", value: "in geofence", description: "\"in geofence\"" },
        peg$c25 = ",",
        ...
        peg$c33 = "did",
        peg$c34 = { type: "literal", value: "did", description: "\"did\"" },
        ...
        peg$c36 = "has",
        peg$c37 = { type: "literal", value: "has", description: "\"has\"" },
        peg$c38 = function(scope, type, conditions, filter1, filter2) {
                  return {
                      scope:scope,
                      type:type,
                      condition:conditions,
        ...
        peg$c39 = function(scope, type, conditions, filter2) {
                 return {
                     scope:scope,
                     type:type,
                     condition:conditions,
        ...
        peg$c40 = "with",
        peg$c41 = { type: "literal", value: "with", description: "\"with\"" },
        peg$c42 = "&",
        peg$c43 = { type: "literal", value: "&", description: "\"&\"" },
        peg$c44 = function(first, remainders) {
                return buildList(first,remainders,3);
            },
        peg$c45 = "nothing",
        peg$c46 = { type: "literal", value: "nothing", description: "\"nothing\"" },
        ...
        peg$c50 = function(type, actionCode, condition) {
                return {
                    type:type,
                    code:actionCode,
        ...
        peg$c51 = "check-in",
        peg$c52 = { type: "literal", value: "check-in", description: "\"check-in\"" },
        peg$c53 = function(type, checkinCode, condition) {
                return {
                    type:type,
                    code:'check-in',
        ...
        peg$c54 = "something",
        peg$c55 = { type: "literal", value: "something", description: "\"something\"" },
        peg$c56 = function(type) {
                return {
                    type:type
                }
            },
        peg$c57 = function(actionCode, condition) {
            	return {
                	type:null,
                    code:actionCode,
                    conditions:condition
        ...
        peg$c58 = function(checkinCode, condition) {
            	return {
                	type:null,
                    code:"check-in",
                     conditions: condition ? condition.concat({
        ...
        peg$c63 = function(type, subType, number, object) {
                return {
                    type:type,
                    sub_type:subType,
                    number:number,
        ...
        peg$c64 = function(subType, number, object) {
                return {
                    type:null,
                    sub_type:subType,
                    number:number,
        ...
        peg$c66 = "points",
        peg$c67 = { type: "literal", value: "points", description: "\"points\"" },
        ...
        peg$c69 = "prize",
        peg$c70 = { type: "literal", value: "prize", description: "\"prize\"" },
        peg$c71 = function(prizeCode) {
                return {
                    type:"prize",
                    prizeCode:prizeCode
                }
        ...
        peg$c72 = "completed",
        peg$c73 = { type: "literal", value: "completed", description: "\"completed\"" },
        peg$c74 = function(type, subType, challengeCode) {
                return {
                    type:type,
                    sub_type:subType,
                    code:challengeCode
        ...
        peg$c75 = function(subType, challengeCode) {
                 return {
                     type:null,
                     sub_type:subType,
                     code:challengeCode
        ...
        peg$c76 = "at least",
        peg$c77 = { type: "literal", value: "at least", description: "\"at least\"" },
        peg$c78 = "times",
        peg$c79 = { type: "literal", value: "times", description: "\"times\"" },
        peg$c80 = "time",
        peg$c81 = { type: "literal", value: "time", description: "\"time\"" },
        ...
        peg$c83 = "less than",
        peg$c84 = { type: "literal", value: "less than", description: "\"less than\"" },
