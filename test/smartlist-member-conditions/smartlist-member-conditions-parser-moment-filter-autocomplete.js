...
describe('<Unit Test>', function () {
	describe('Auto-Complete Moment Filter Smartlist Member Conditions:', function () {
		var literalChoices;
		var otherChoices;
			...
			describe('should auto-complete', function () {
				...
				it('member did action eat ', function () {
					try {
						...
						should(literalChoices).eql(['after', 'and', 'at least', 'before', 'between', 'during the', 'exactly','in geofence', 'in last', 'in range of', 'less than', 'since', 'with RSSI', 'with']);
