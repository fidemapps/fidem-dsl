	...
	describe('Content Member Conditions did:', function () {
		...
		describe('should parse did condition', function () {
			...
			describe('action', function () {
				...
				it('member did not action TEST with jean < "thomas" less than 3 times in zone montreal,laval after 2016-03-03 4:40', function () {
					var rule = parser.parse('member did not action TEST with jean < "thomas" less than 3 times in zone montreal,laval after 2016-03-03 4:40');
					should(rule).eql({
						conditions: [
							{
								scope: 'member',
