...
describe('<Unit Test>', function () {
    describe('Auto-Complete Challenge Availability Member Condition Rules did:', function () {
        var literalChoices;
        var otherChoices;
        ...
        describe('did',function(){
            ...
            describe('should auto-complete',function(){
                ...
                it('member did actionCode with attributeName = \"attributeValue\" & attributeName',function(){
                    try {
                        parser.parse('member did eat with bob = \"bob\" & jean 3');
                    } catch (error) {
                        literalChoices = helper.extractLiterals(error);
                        otherChoices = helper.extractOthers(error);
                ...
                it('member did actionCode with attributeName = \"attributeValue\" & attributeName >',function(){
                    try {
                        parser.parse('member did eat with bob = \"bob\" & jean >');
                    } catch (error) {
                        otherChoices = helper.extractOthers(error);
                        literalChoices = helper.extractLiterals(error);
