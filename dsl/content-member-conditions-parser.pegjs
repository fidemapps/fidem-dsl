...
/scope:"member" S+ "belongs to smartlist" S+ condition:smartlist_condition
{
    return {
       scope: scope,
       type:"belongs",
...
/scope:"member" S+ "does not belong to smartlist" S+ condition:smartlist_condition
{
    return {
       scope: scope,
       type:"belongs",
...
did_rule
="action" S+ actionCode:actionCode condition:member_action_condition?
{
    var rule= {
        type:'action',
